...
public class StartupViewController implements Initializable
{
    ...
    public StartupViewController(StartupMainController startupMainController)
    {
        this.startupMainController = startupMainController;
    }

    @Override
    public void initialize(URL location, ResourceBundle resources)
    {
        //inject MainController into loginViewController & registrationViewController
        loginViewController.injectMainController(this);
        registrationViewController.injectMainController(this);
    ...
    {
        this.startupMainController.openChatRoomScene(loginUser);
    }
    ...
    public User getLoginUser(String phone, String password) {
        return startupMainController.loginService(phone, password);
    }
    public boolean registerNewUser(User newUser){
        return startupMainController.registerService(newUser);
    }
}
